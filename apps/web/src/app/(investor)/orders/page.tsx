...
export default function InvestorOrdersPage() {
  ...
  return (
    <motion.div 
      ...
      className="space-y-8 pb-12 max-w-[1152px] mx-auto text-[#1f1633] dark:text-white"
    >
      <div className="space-y-8">
        
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h1 className="text-[30px] font-bold text-[#1f1633] dark:text-white mb-2 leading-tight">My Investment Orders</h1>
            <p className="text-[#79628c] dark:text-on-dark-muted">Track and manage your bond allocations.</p>
          </div>
          <button 
            onClick={fetchOrders} 
        ...
        {loading ? (
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-[#cfcfdb] dark:border-hairline-violet bg-[#f9fafb] dark:bg-[#1a1130]">
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase">Order No.</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase">Bond</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase">Amount</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase text-right">Status</th>
                  </tr>
                </thead>
                <tbody>
                  <SkeletonRow cols={4} />
          ...
          <EmptyState 
            ...
            description="You have not submitted any bond purchase orders yet. Browse our marketplace to view open listings."
          ...
          <div className="bg-white dark:bg-ink-deep rounded-xl border border-[#e5e7eb] dark:border-hairline-violet shadow-sm overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-[#cfcfdb] dark:border-hairline-violet bg-[#f9fafb] dark:bg-[#1a1130]">
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase tracking-wider">Order No.</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase tracking-wider">Bond</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase tracking-wider">Amount</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase tracking-wider">Date</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase tracking-wider">Status</th>
                    <th className="py-4 px-6 text-[12px] font-semibold text-[#79628c] dark:text-on-dark-muted uppercase tracking-wider text-right">Actions</th>
                  </tr>
                </thead>
                  ...
                  {orders.map((order) => (
                    <tr key={order.id} className="hover:bg-[#f9fafb] dark:hover:bg-[#1f1735]/40 transition-colors">
                      ...
                      <td className="py-4 px-6">
                        ...
                        <div className="text-[12px] text-[#79628c] dark:text-on-dark-muted">Rate: {order.bond?.couponRate}%</div>
                      </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="bg-white dark:bg-ink-deep border border-slate-200 dark:border-hairline-violet rounded-xl max-w-md w-full p-6 shadow-xl relative">
            ...
            <h2 className="text-[20px] font-bold text-[#1f1633] dark:text-white mb-2 flex items-center gap-2">
              <UploadCloud size={24} className="text-[#6a5fc1] dark:text-accent-lime" /> Upload Receipt
            </h2>
